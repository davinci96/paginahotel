<form method="POST" action="<?php echo base_url().'/add-apart'?> " enctype="multipart/form-data">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="mb-3 col-5">
                ...
                <input type="text" name="direccion" class="form-control" id="direccion" aria-describedby="emailHelp">
            </div>
            <div class="mb-3 col-5">
        ...
        <div class="row">
            <div class="mb-3 col-5">
                ...
                <input type="number" name="num_habitacion" class="form-control" id="numero" aria-describedby="emailHelp">
            </div>
            <div class="mb-3 col-5">
                <label for="imagenes" class="form-label">Imagenes del apartamento</label>
                <input type="text" name="imagenes" class="form-control" id="imagenes" aria-describedby="emailHelp">
            </div>
        </div>
        <div class="row">
            <div class="mb-3 col-5">
                <label for="imagen" class="form-label">Imagen destacada</label>
                <input type="file" name="imagen_destacada" class="form-control" id="imagen" aria-describedby="emailHelp">
            </div>
            <div class="mb-3 col-5">
                <label for="valor" class="form-label">Valor por noche</label>
                <input type="number" name="valor" class="form-control" id="valor" aria-describedby="emailHelp">
            </div>
        </div>
        <div class="row">
        ...
        <button type="submit" class="btn btn-primary">Resgistrar apartamento</button>
    </div>
</form>